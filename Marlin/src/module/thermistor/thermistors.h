...
#define ANY_THERMISTOR_IS(n) (THERMISTORHEATER_0 == n || THERMISTORHEATER_1 == n || THERMISTORHEATER_2 == n || THERMISTORHEATER_3 == n || THERMISTORHEATER_4 == n || THERMISTORBED == n || INTERCHANGEABLE_HOTEND_THERM0 == n || INTERCHANGEABLE_HOTEND_THERM1 == n || INTERCHANGEABLE_HOTEND_THERM2 == n || INTERCHANGEABLE_HOTEND_THERM3 == n || INTERCHANGEABLE_HOTEND_THERM4 == n)
...
// For thermocouples the highest temperature results in the highest ADC value
	...
	#ifdef ICH_THERMISTOR_0
	  #define ICH_0_TEMPTABLE TT_NAME(ICH_THERMISTOR_0)
	  #define ICH_0_TEMPTABLE_LEN COUNT(ICH_0_TEMPTABLE)
	#else
	  #define ICH_0_TEMPTABLE NULL
	  #define ICH_0_TEMPTABLE_LEN 0
	#endif
	#ifdef ICH_THERMISTOR_1
	  #define ICH_1_TEMPTABLE TT_NAME(ICH_THERMISTOR_1)
	  #define ICH_1_TEMPTABLE_LEN COUNT(ICH_1_TEMPTABLE)
	#else
	  #define ICH_1_TEMPTABLE NULL
	  #define ICH_1_TEMPTABLE_LEN 0
	#endif
	#ifdef ICH_THERMISTOR_2
	  #define ICH_2_TEMPTABLE TT_NAME(ICH_THERMISTOR_2)
	  #define ICH_2_TEMPTABLE_LEN COUNT(ICH_2_TEMPTABLE)
	#else
	  #define ICH_2_TEMPTABLE NULL
	  #define ICH_2_TEMPTABLE_LEN 0
	#endif
	#ifdef ICH_THERMISTOR_3
	  #define ICH_3_TEMPTABLE TT_NAME(ICH_THERMISTOR_3)
	  #define ICH_3_TEMPTABLE_LEN COUNT(ICH_3_TEMPTABLE)
	#else
	  #define ICH_3_TEMPTABLE NULL
	  #define ICH_3_TEMPTABLE_LEN 0
	#endif
	#ifdef ICH_THERMISTOR_4
	  #define ICH_4_TEMPTABLE TT_NAME(ICH_THERMISTOR_4)
	  #define ICH_4_TEMPTABLE_LEN COUNT(ICH_4_TEMPTABLE)
	#else
	  #define ICH_4_TEMPTABLE NULL
	  #define ICH_4_TEMPTABLE_LEN 0
	#endif
