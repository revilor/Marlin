...
// needs to be here so that we catch the above changes to our defines
  ...
  #define HAS_FOLDER_SORTING (FOLDER_SORTING || ENABLED(SDSORT_GCODE))
	...
	#if INTERCHANGEABLE_HOTEND_THERM0 > 0
      #define ICH_THERMISTOR_0 INTERCHANGEABLE_HOTEND_THERM0
    #endif
	#if INTERCHANGEABLE_HOTEND_THERM1 > 0
	  #define ICH_THERMISTOR_1 INTERCHANGEABLE_HOTEND_THERM1
	#endif

	#if INTERCHANGEABLE_HOTEND_THERM2 > 0
	  #define ICH_THERMISTOR_2 INTERCHANGEABLE_HOTEND_THERM2
	#endif

	#if INTERCHANGEABLE_HOTEND_THERM3 > 0
	  #define ICH_THERMISTOR_3 INTERCHANGEABLE_HOTEND_THERM3
	#endif

	#if INTERCHANGEABLE_HOTEND_THERM4 > 0
	  #define ICH_THERMISTOR_4 INTERCHANGEABLE_HOTEND_THERM4
	#endif
#endif
